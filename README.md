...
In onder to make the Stanfor40 dataset to be suitable for this training it should be prepared with my repository [Stanford40DataLoader](https://github.com/m-zafari/Stanford40DataLoader)
